...
Cohesion: 0.06
Nodes (46): App(), AlternateSelection(), ChangePasswordModal(), CollegueInfo(), DashboardNotification(), HoDLayout(), HoDNavbar(), HRLayout() (+38 more)
...
Cohesion: 0.18
Nodes (7): User, authMiddleware, express, roleController, router, upload, userController
...
- **Why does `exportSectionToPDF()` connect `Community 11` to `Community 4`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `jspdf` connect `Community 4` to `Community 11`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
